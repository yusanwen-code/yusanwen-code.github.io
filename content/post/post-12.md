...
支付平台跑得够久，账对不平只是时间问题。我们同时对接微信、支付宝、银联好几个渠道，每天几十万笔交易，渠道回调可能丢、可能重放、可能金额被篡改，还可能跨日清算。靠运营每天拉 Excel 肉眼比对？迟早出大事。
...
![对账模块四层：从渠道文件到差异工单](/images/post-12-reconcile-flow.svg)

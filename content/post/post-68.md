...
![排障三步：监控定边界、链路定位置、日志看细节](/images/post-68-triage-steps.svg)
...
排障能力的本质不是"见过的错误多"，而是有一套不依赖运气的检索路径。监控告诉你"哪里不对"，链路告诉你"在哪一步不对"，日志告诉你"具体为什么不对"。三件事平时建设好，告警响的时候才不会慌。工具是基础设施，方法论才是让你比别人快十分钟定位问题的关键。

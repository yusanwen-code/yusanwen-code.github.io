...
最近有几个刚工作两三年的后端朋友问我：AI 这么火，传统后端是不是要被淘汰了？要不要转算法？我自己这两年从某 SaaS 公司的宠物医疗 SaaS 走到公司的 AI 数据平台，又在业余时间开源了 alchemy-furnace，刚好完整经历了从"写 CRUD"到"做 AI 系统"的转变。这篇把我的成长路径拆开聊聊，不一定适合每个人，但都是我真走过的路。
...
2023 年底我加入公司，本来是做 统一支付平台 支付和 统一认证中心 认证这种传统后端项目，但我主动接了 数据治理服务 和 数据集管理服务 里和 AI 相关的部分。这是我职业路径上最关键的一个选择。
...
- **LLM 网关**：知识库问答服务 里做统一 LLM 适配层，屏蔽 OpenAI、Azure、VLLM、HuggingFace 的差异，做多模型路由、限流、降级、token 计费。这是后端最能发挥价值的地方。
